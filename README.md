...
For an in depth look at the entire development cycle read my full [Undergraduate Project Report](./docs/Mohammed_Hamza_Huda_UG_Project_Report.pdf).

<table>
  <tr>
    <td>
      <img src="./docs/workout-screen.png" alt="The workout screen where a user fills in their lifts while at the gym" width="300"/>
    </td>
    <td>
      <img src="./docs/progress-screen.png" alt="The progress screen for a user's Incline Bench, the screen displays a graph with their progress over time normalised to 1RM with a regression line and a predicted timeline for their goal" width="300"/>
    </td>
  </tr>
</table>
